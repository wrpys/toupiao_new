...
<html>
  <head>
    <style type="text/css">
        .Header {background: url(<%=path %>/img/banner.jpg) #d10e00 repeat-x left top; height:164px; width: 966px;}
     ...
     <script type="text/javascript">
	           ...
	           function bzjs()
	        {
	            ...
	            function cyjzff()
	        {
	                var url="<%=path %>/qiantai/cyjzff.jsp";
	                var n="";
	                var w="480px";
	                var h="500px";
	                var s="resizable:no;help:no;status:no;scroll:yes";
	         ...
	         function zyzjs()
	        {
	                var url="<%=path %>/qiantai/zyzjs.jsp";
	                var n="";
	                var w="480px";
	                var h="500px";
	                var s="resizable:no;help:no;status:no;scroll:yes";
  ...
  <body>
		...
		<div class="topmenu cbody1">
			<ul>
				...
				<li class="thisclass">
					<A href="toupiao/introductionIOfSite.action">本站介绍</A>
				</li>
